...
export function MealAddFoodSheet({ meal_type, action, quick_pick_items }: MealAddFoodSheetProps) {
  ...
  return (
    <>
      ...
      {is_open ? (
        <div className="fixed inset-0 z-50 flex items-end justify-center overflow-x-hidden overscroll-x-none bg-slate-900/50 px-4">
          <button
            type="button"
          ...
          />
          <section className="relative z-10 max-h-[90vh] w-full max-w-md touch-pan-y overflow-x-hidden overflow-y-auto overscroll-x-none rounded-t-2xl bg-white p-4 shadow-2xl">
